...
export default function Usage({
  ...
  // Update progress bar width after render
  useEffect(() => {
    if (progressRef.current) {
      const calculatedProgress =
        ((featureUsage || 0) / (featureAllocation || 1)) * 100;
      progressRef.current.style.width = `${calculatedProgress}%`;
    }
  }, [featureUsage, featureAllocation, refreshCount]);
    ...
    return (
      <div className="bg-white rounded-2xl shadow-sm border border-red-100 p-6">
        ...
        <div className="relative">
          <div className="h-3 rounded-full bg-gray-100 w-full overflow-hidden">
            <div
...
//           <Progress
//             value={100}
//             className="h-3 rounded-full bg-gray-100 [&>*]:bg-red-600 [&>*]:transition-all [&>*]:duration-300 [&>*]:ease-in-out"
//           />
//           <p className="text-sm text-red-600 mt-2">
//             You have used all available tokens. Please upgrade your plan to
//             continue using this feature.
...
//           <Progress
//             value={0}
//             className="h-3 rounded-full bg-gray-100 [&>*]:transition-all [&>*]:duration-300 [&>*]:ease-in-out"
//           />
//           <p className="text-sm text-gray-600 mt-2">
//             Upgrade to use this feature
//           </p>
...
//           key={`progress-${refreshCount}-${featureUsage}`}
//           value={progress}
//           className={`h-3 rounded-full bg-gray-100 ${progressColor} [&>*]:transition-all [&>*]:duration-300 [&>*]:ease-in-out`}
//         />
